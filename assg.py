...
CS 456 - Computer Vision

Student Name: [Abdulaziz Fahad Alqarzaie]
Student ID: [443015924]

Programming Language: Python
Libraries Used: OpenCV (cv2), NumPy, Matplotlib

This program demonstrates several point processing operations:
1. Image loading and display with property analysis
2. Image negation
3. Binary thresholding with different threshold values.
"""
